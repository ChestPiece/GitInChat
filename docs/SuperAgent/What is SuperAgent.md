...
<Cards className="grid-cols-4">
  <IconCard title="Guard" href="/sdk/sdk/typescript#guard" description="Detect and block prompt injections, malicious instructions, and unsafe tool calls" icon={<Shield className="size-4" />} />

  <IconCard title="Redact" href="/sdk/sdk/typescript#redact" description="Remove PII, PHI, and secrets from text automatically" icon={<EyeOff className="size-4" />} />

  <IconCard title="Scan" href="/sdk/sdk/typescript#scan" description="Analyze repositories for AI agent-targeted attacks" icon={<Search className="size-4" />} />

  <IconCard title="Test" href="/sdk/quickstart#test" description="Run red team scenarios against your production agent" icon={<FlaskConical className="size-4" />} />
</Cards>
...
<Cards className="grid-cols-2">
  <IconCard title="Quickstart" href="/sdk/quickstart" description="Install the SDK and make your first call in minutes" icon={<Rocket className="size-4" />} />

  <IconCard title="TypeScript SDK" href="/sdk/sdk/typescript" description="Full API reference for TypeScript" icon={<Code className="size-4" />} />

  <IconCard title="Python SDK" href="/sdk/sdk/python" description="Full API reference for Python" icon={<Code className="size-4" />} />

  <IconCard title="Providers" href="/sdk/providers" description="Supported LLM providers and configuration" icon={<Server className="size-4" />} />
</Cards>
...
* **X (Twitter)**: Follow [@superagent\_ai](https://x.com/superagent_ai) for updates and announcements
