...
URL: /sdk/examples/scan-image-uploads
...
```bash title="Terminal"
npm install safety-agent ai@^6.0.0 @ai-sdk/react @ai-sdk/openai
```
...
<img alt="Visual prompt injection example showing two people, one holding a sign with malicious instructions" src={__img0} placeholder="blur" />
...
* Learn about the [TypeScript SDK](/sdk/sdk/typescript) for detailed API reference
* Check out [Secure your RAG pipeline](/sdk/examples/secure-rag-pipeline) for PDF scanning
* Check out the [Quickstart guide](/sdk/quickstart) to get started quickly
